                    ...
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-br-lg rounded-bl-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-tl-lg lg:rounded-br-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            ...
                            <p className="mb-6 text-[#706f6c] dark:text-[#A1A09A]">
                                Plataforma integral para la evaluación de competencias y desempeño.
                                <br />
                                Conecta Managers y Candidatos en un proceso fluido y eficiente.
                            </p>
                            <ul className="mb-8 flex flex-col gap-2 text-sm text-[#706f6c] dark:text-[#A1A09A]">
                                <li className="flex items-center gap-2">
                                    <span className="h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                                    Creación y asignación de evaluaciones personalizadas.
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                                    Seguimiento en tiempo real del progreso de los candidatos.
                                </li>
                                <li className="flex items-center gap-2">
                                    <span className="h-1.5 w-1.5 rounded-full bg-[#dbdbd7] dark:bg-[#3E3E3A]" />
                             ...
                             <div className="flex gap-3">
                                {auth.user ? (
                                     <Link
                                        href="/assessments"
                                        className="inline-flex items-center justify-center rounded-md bg-[#1b1b18] px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-[#1b1b18]/90 focus:outline-none focus:ring-2 focus:ring-[#1b1b18] focus:ring-offset-2 dark:bg-[#EDEDEC] dark:text-[#161615] dark:hover:bg-[#EDEDEC]/90"
                                    >
                                        Ir a Assessments
                                    </Link>
                                ) : (
                        ...
                        <div className="relative -mb-px aspect-[335/376] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#f4f4f5] lg:mb-0 lg:-ml-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-r-lg dark:bg-[#1f1f1e]">
                            <div className="flex h-full w-full flex-col items-center justify-center p-8 text-center">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="mb-4 h-24 w-24 text-[#1b1b18] dark:text-[#EDEDEC] opacity-20">
                                  <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                </svg>
                                <h3 className="text-lg font-medium text-[#1b1b18] dark:text-[#EDEDEC]">Evaluaciones 360°</h3>
                                <p className="mt-2 text-sm text-[#706f6c] dark:text-[#A1A09A]">
                                    Optimiza el talento de tu organización con herramientas modernas y fáciles de usar.
                                </p>
                            </div>
